...
class NPCBase(object):
    ...
    def speakTree(self, tree, farewell=None):
        ...
        if isinstance(greet, collections.abc.Callable) or type(greet) == str:
            self.greet(greet)
        else:
            ...
            def _greet(npc, player):
                ...
                # Function
                elif isinstance(greet, collections.abc.Callable):
        ...
        def openTree(npc, player):
            ...
            while True:
                ...
                if response in currElm:
                    ...
                    # Function
                    elif isinstance(nextElm, collections.abc.Callable):
        ...
        # Register farewell
        if farewell:
            if isinstance(farewell, collections.abc.Callable) or type(farewell) == str:
                ...
                def _farewell(npc, player):
                    ...
                    # Function
                    elif isinstance(farewell, collections.abc.Callable):
